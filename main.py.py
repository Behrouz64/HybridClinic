...
# =====================================================================
# ۱. بخش مدیریت پایگاه داده (DATABASE MANAGER - JSON BASED)
# =====================================================================
# 🟢 ترفند طلایی اندروید: پیدا کردن مسیر نصب خود برنامه (که 100% دسترسی نوشتن دارد و دائمی است)
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
APP_DATA_DIR = os.path.join(BASE_DIR, "clinic_data")
...
class SettingsView(ft.View):
    def __init__(self, page: ft.Page):
        ...
        self.status_text = ft.Text(f"دیتابیس متصل شد.", color=ft.Colors.BLUE, size=12)
...
# =====================================================================
# ۵. بخش روتینگ با سیستم ضد کرش
# =====================================================================
def main(page: ft.Page):
    try:
        # فراخوانی هوشمند ساخت دیتابیس بومی
        initialize_database()
        ...
        page.scroll = "auto"
        page.add(
            ft.Text("🚨 خطای بحرانی پایتون", color="white", bgcolor="red", weight="bold", size=18),
